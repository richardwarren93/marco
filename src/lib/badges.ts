...
export const BADGES: BadgeDefinition[] = [
  // ── Recipes ──
  {
    ...
    icon: "🍳",
    imageUrl: "/badges/first-bite.svg",
    category: "recipes",
    tier: "bronze",
  ...
  },
  {
    ...
    icon: "📚",
    imageUrl: "/badges/recipe-hoarder.svg",
    category: "recipes",
    tier: "gold",
    statKey: "totalRecipes",
    threshold: 50,
  },
  {
    ...
    icon: "🌍",
    imageUrl: "/badges/world-traveler.svg",
    category: "recipes",
    tier: "bronze",
  ...
  },
  {
    ...
    icon: "✈️",
    imageUrl: "/badges/globe-trotter.svg",
    category: "recipes",
    tier: "silver",
    statKey: "uniqueCuisines",
    threshold: 7,
  ...
  },
  {
    ...
    icon: "🗓️",
    imageUrl: "/badges/meal-prepper.svg",
    category: "meal_plan",
    tier: "silver",
  ...
  },
  {
    ...
    icon: "💪",
    imageUrl: "/badges/fully-booked.svg",
    category: "meal_plan",
    tier: "gold",
  ...
  // ── Cooking ──
  {
    ...
    icon: "🔥",
    imageUrl: "/badges/first-flame.svg",
    category: "cooking",
    tier: "bronze",
    statKey: "totalCooks",
    threshold: 1,
  },
  {
    ...
    icon: "🍲",
    imageUrl: "/badges/getting-warm.svg",
    category: "cooking",
    tier: "silver",
    statKey: "totalCooks",
    threshold: 10,
  ...
  },
  {
    ...
    icon: "📸",
    imageUrl: "/badges/food-photographer.svg",
    category: "cooking",
    tier: "bronze",
  ...
  },
  {
    ...
    icon: "🎯",
    imageUrl: "/badges/goal-getter.svg",
    category: "cooking",
    tier: "bronze",
  ...
  },
  {
    ...
    icon: "🏆",
    imageUrl: "/badges/consistent-cook.svg",
    category: "cooking",
    tier: "silver",
    statKey: "weeksGoalMet",
    threshold: 4,
  ...
  },
  {
    ...
    icon: "🎨",
    imageUrl: "/badges/variety-chef.svg",
    category: "cooking",
    tier: "silver",
  ...
  // ── Special ──
  {
    ...
    icon: "🍰",
    imageUrl: "/badges/sweet-tooth.svg",
    category: "cooking",
    tier: "silver",
  ...
  },
  {
    ...
    icon: "🗃️",
    imageUrl: "/badges/organized-kitchen.svg",
    category: "collections",
    tier: "silver",
    statKey: "totalCollections",
    threshold: 3,
  ...
  // ── Social ──
  {
    ...
    icon: "🤝",
    imageUrl: "/badges/kitchen-buddy.svg",
    category: "social",
    tier: "bronze",
  ...
  },
  {
    ...
    icon: "🎉",
    imageUrl: "/badges/dinner-party.svg",
    category: "social",
    tier: "silver",
    statKey: "totalFriends",
    threshold: 5,
  },
  {
    ...
    icon: "🍅",
    imageUrl: "/badges/tomato-farmer.svg",
    category: "social",
    tier: "bronze",
  ...
  },
  {
    ...
    icon: "🍅",
    imageUrl: "/badges/tomato-tycoon.svg",
    category: "social",
    tier: "gold",
    statKey: "totalTomatoes",
    threshold: 500,
