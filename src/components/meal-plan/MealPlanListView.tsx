        ...
        {onShowInsights && (
          <div className="flex justify-end mt-1">
            <button
              ...
              className="flex items-center gap-1 text-[10px] font-semibold px-2.5 py-1 rounded-full transition-colors active:scale-95"
