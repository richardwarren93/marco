...
export default function ScheduleScreen({
  ...
  return (
    <div className="flex flex-col min-h-screen" style={{ background: "#faf9f7" }}>
      {/* Sticky header */}
      <div className="px-4 pt-4 pb-0 sticky top-0 z-10" style={{ background: "#faf9f7" }}>
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h1 className="text-2xl font-black tracking-tight" style={{ color: "#1a1410" }}>Meal Plan</h1>
            </div>
            <div className="flex items-center gap-2">
              <button
                onClick={onShowInsights}
                className="flex items-center gap-1.5 text-xs font-bold px-3 py-2 rounded-2xl transition-colors"
                style={{ background: "white", color: "#1a1410", boxShadow: "0 1px 6px rgba(0,0,0,0.08)" }}
              >
              ...
              <button
                ...
                className="flex items-center gap-1.5 text-xs font-bold text-white px-3 py-2 rounded-2xl active:scale-95 transition-transform"
