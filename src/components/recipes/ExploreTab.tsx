  ...
  return (
    <div className="max-w-3xl mx-auto px-4 pb-28">
      ...
      <div className="text-center pt-2 pb-5">
        ...
        <h2 className="text-lg font-bold text-gray-900 mb-1">Explore New Recipes</h2>
        <p className="text-sm text-gray-400">Tell us what you&apos;re craving, and we&apos;ll find it</p>
      </div>
