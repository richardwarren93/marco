    ...
    <div className="flex flex-col h-full px-6 pb-24">
      ...
      <div className="flex items-center justify-center gap-8 py-8 animate-stagger-in">
        <button
          ...
          style={{ background: "white", border: "2px solid #e8e8e5", color: "#1C1A17" }}
        >
          -
        </button>

        <div className="text-center">
          <span className="text-7xl font-black" style={{ color: "#1C1A17" }}>
            {count}
          </span>
      ...
      <div className="pt-6">
        <button
          ...
          style={{ background: count > 1 && !hType ? "#d4d0cc" : "#1C1A17" }}
        >
          Continue
        </button>
      </div>
